...
export default function FileUploadScreen() {
  ...
  const pickFile = async () => {
    try {
      ...
      formData.append("file", { uri: fileUri, name: fileName, type: "application/pdf" });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Ionicons name="document-attach-outline" size={70} color="#fff" style={{ marginVertical: 20 }} />
        {uploading ? <ActivityIndicator size="large" color="#B4BD00" /> : <TouchableOpacity style={styles.chooseButton} onPress={pickFile}><Text style={styles.chooseButtonText}>Choose File</Text></TouchableOpacity>}
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#0B4F6C", width: "80%", paddingVertical: 150, paddingHorizontal: 20, borderRadius: 25, alignItems: "center", elevation: 6 },
  ...
  chooseButtonText: { color: "#fff", fontWeight: "bold", fontSize: 18 },
});
